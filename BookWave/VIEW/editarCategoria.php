        ...
        <div class="form-criar-crachas">
            ...
            <div>
                ...
                <div class="centro-cadastro">
                    <form id="form_editar" enctype="multipart/form-data"  method="POST" action="../PHP/editarCategoria.php">  
                        ...
                        <div>
                            ...
                            <input class="input" minlength="1" type="text" name="nome" id="inputNome" placeholder="Nome da Categoria" value="<?php echo $dados['nome']; ?>" required><br>
                        </div>

                        <br>

                        <div class="btn1">
                            <button class="input-botão" type="submit">Editar</button>
                        </div>
                    </form>   
                <div>
    </body>
